...
function KrankenkasseSteps(props) {
    ...
    const checkIfSwiss = (event) => {
        if (event.target.value === "swiss") {
            setisSwiss(true)
        }
        else {
            setisSwiss(false)
    ...
    const natinalityCheck = (event) => {

        setNationalitat(event.target.value)
        checkIfSwiss(event)
    }
    return (
        <>
            <form onSubmit={handleSubmit}>
                ...
                <div className='col-12 col-xl-11 col-xxl-10 mx-auto'>

                    {secondStep && (
                        <div ref={secondStepKranken} className='krankenSecondStep wrapDiv container-xl px-0 px-sm-4 px-xl-0 pt-5'>

                            <div className='m-5 mx-auto fs-5' style={{ position: "relative" }}>
                                <svg style={{ position: 'absolute' }} height="100" width="100" viewBox="0 0 100 100" className='testrtr'  >
                                    <circle cx="50" cy="50" r="45" stroke="#27B0Ed44" strokeWidth="3" fillOpacity="0" />
                                </svg>
                                <svg height="100" width="100" viewBox="0 0 100 100" className='testrtr'  >
                                    <circle className="circle" cx="50" cy="50" r="45" stroke="#27B0Ed" strokeWidth="3" fillOpacity="0" />
                                    <text x="35" y="55" fontSize={20} fontWeight={500}>2/5</text>
                                </svg>
                            </div>
                                        ...
                                        <div className="row gy-4 gx-0 gx-md-4" >
                                            <div className="col-12 col-sm-6">
                                                <label htmlFor="yesFirstRadio" className='container1 w-100'>
                                                    ...
                                                    <span className='checkmark checkmarkBoxShadow'>Ja, ich bin bereits versichert</span>
                                                </label>
                                            </div>
                                            <div className="col-12 col-sm-6">
                                                <label htmlFor="noFirstRadio" className='container1 w-100'>
                                                    ...
                                                    <span className='checkmark checkmarkBoxShadow'>
                                        ...
                                        <div className="row gy-4 gx-0 gx-md-4">
                                            <div className="col-12 col-sm-6 col-md-4">
                                                <label onChange={(e) => { setFamilySituation('familie') }} htmlFor="familieradio" className='container1 w-100'>
                                                    ...
                                                    <span className='checkmark checkmarkBoxShadow'>Familie</span>
                                                </label>
                                            </div>
                                            <div className="col-12 col-sm-6 col-md-4">
                                                <label onChange={(e) => { setFamilySituation('paar') }} htmlFor="paarradio" className='container1 w-100'>
                                                    ...
                                                    <span className='checkmark checkmarkBoxShadow'>Paar</span>
                                                </label>
                                            </div>
                                            <div className="col-12 col-sm-6 col-md-4">
                                                <label onChange={(e) => { setFamilySituation('einzel') }} htmlFor="einzelradio" className='container1 w-100'>
                                                    ...
                                                    <span className='checkmark checkmarkBoxShadow'>Einzelperson</span>
                                                </label>
                                            </div>
                                        </div>
                                        {error2 && (
                                                        ...
                                                        <div className="row gy-4 gx-0 gx-md-4">
                                                            <div className="col-12 col-sm-6">
                                                                <label onChange={(e) => { setFamilySituation2('familie') }} htmlFor="familieModel" className='container1 w-100'>
                                                                    ...
                                                                    <span className='checkmark checkmarkBoxShadow'>Gesamte Familie gleiches Modell</span>
                                                                </label>
                                                            </div>
                                                            <div className="col-12 col-sm-6">
                                                                <label onChange={(e) => { setFamilySituation2('individual') }} htmlFor="individualModel" className='container1 w-100'>
                                                                    ...
                                                                    <span className='checkmark checkmarkBoxShadow'>Individuelle Modelle</span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        {error3 && (
                        ...
                        <div ref={thirdStepKranken} className='wrapDiv container-xl px-0 px-sm-4 px-xl-0 pt-5'>
                            <div className='krankenSecondStep'>
                                <div className='m-5 mx-auto fs-5' style={{ position: "relative" }}>
                                    ...
                                    <svg height="100" width="100" viewBox="0 0 100 100" className='testrtr'  >
                                        <circle className="circle" cx="50" cy="50" r="45" stroke="#27B0Ed" strokeWidth="3" fillOpacity="0" />
                                        <text x="35" y="55" fontSize={20} fontWeight={500}>3/5</text>
                                    </svg>
                                </div>
                                <div className='pb-1'>
                                    ...
                                    <div className="row g-4">
                                        <div className="col-6 col-md-3">
                                            <label onChange={() => { setGender('male') }} htmlFor="maleRadio" className='container1 w-100'>
                                                ...
                                                <span className='checkmark checkmarkBoxShadow'>Herr</span>
                                            </label>
                                        </div>
                                        <div className="col-6 col-md-3">
                                            <label onChange={() => { setGender('female') }} htmlFor="femaleRadio" className='container1 w-100'>
                                                ...
                                                <span className='checkmark checkmarkBoxShadow'>Frau</span>
                                            </label>
                                        </div>
                                        <div className="col-12 col-md-6">
                                            <input type="text" name="" id="" onChange={(e) => setVornameValue(e.target.value)} placeholder='Vorname & Nachname' className='krankenInputStyle krankenInputStepStyle p-2 p-3 krankenBoxShadowInput' />
                                        </div>
                                        <div className="col-12 col-md-6">
                                            <input type="number" name='Jahrgang'
                                                ...
                                                className='krankenInputStyle krankenInputStepStyle p-2 p-3 krankenBoxShadowInput' />
                                        </div>
                                        <div className="col-12 col-md-6">
                                            <select onChange={(e) => { setPrice(e.target.value) }} disabled={checkJahr ? false : "disabled"} name="franchise" id="" className='krankenInputStyle form-select krankenInputStepStyle p-3 krankenBoxShadowInput'>
                                        ...
                                        <div className="col-12 col-md-6">
                                            <label htmlFor="mit" className='container1 w-100'>
                                                ...
                                                <span className='checkmark checkmarkBoxShadow'>mit Unfall</span>
                                            </label>
                                        </div>
                                        <div className="col-12 col-md-6">
                                            <label htmlFor="ohne" className='container1 w-100'>
                                                ...
                                                <span className='checkmark checkmarkBoxShadow'>ohne Unfall</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className='col-12 col-sm-8 col-md-4 col-lg-3 mx-auto pt-4 pb-5'>
                                <select name="" id="" required onChange={(e) => setmodels(e)} className='krankenInputStyle form-select krankenInputStepStyle p-3 krankenBoxShadowInput'>
                                    ...
                                    <div className="row g-4">
                                        <div className="col-12 col-sm-6 col-lg-3">
                                            <label htmlFor="Standard" className='container1 w-100'>
                                                ...
                                                <span className='checkmark checkmarkBoxShadow'>Standard</span>
                                            </label>
                                        </div>
                                        <div className="col-12 col-sm-6 col-lg-3">
                                            <label htmlFor="Hausarzt" className='container1 w-100'>
                                                ...
                                                <span className='checkmark checkmarkBoxShadow'>Hausarzt</span>
                                            </label>
                                        </div>
                                        <div className="col-12 col-sm-6 col-lg-3">
                                            <label htmlFor="HMO" className='container1 w-100'>
                                                ...
                                                <span className='checkmark checkmarkBoxShadow'>HMO</span>
                                            </label>
                                        </div>
                                        <div className="col-12 col-sm-6 col-lg-3">
                                            <label htmlFor="Weitere" className='container1 w-100'>
                                                ...
                                                <span className='checkmark checkmarkBoxShadow'>Weitere Modelle</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                    ...
                    {thirdStep2 && (
                        <div ref={third2StepKranken} className=' pt-5'>
                            ...
                            <div className='wrapDiv container-xl px-0 px-sm-4 px-xl-5 pt-5'>
                                <div className='krankenSecondStep'>
                                    <div className='m-5 mx-auto fs-5' style={{ position: "relative" }}>
                                        ...
                                        <svg height="100" width="100" viewBox="0 0 100 100" className='testrtr'  >
                                            <circle className="circle" cx="50" cy="50" r="45" stroke="#27B0Ed" strokeWidth="3" fillOpacity="0" />
                                            <text x="35" y="55" fontSize={20} fontWeight={500}>4/5</text>
                                        </svg>
                                    </div>
                                    <div className='pb-1'>
                                        ...
                                        <div className="row g-4 justify-content-center">
                                            <div className="col-12 col-sm-6 col-md-4">
                                                <label htmlFor="spitalCheckbox" className='container1 w-100'>
                                                    ...
                                                    <div className='checkmark py-5 checkmarkWidth checkmarkBoxShadow'>
                                                        <div className='pb-3'>
                                            ...
                                            <div className="row g-4">
                                                <div className="col-12 col-md-6">
                                                    <label htmlFor="step4Email" className='container1 w-100'>
                                                        ...
                                                        <span className='checkmark checkmarkBoxShadow'>Unverbindliche Offerte per E-Mail zusenden</span>
                                                    </label>
                                                </div>
                                                <div className="col-12 col-md-6">
                                                    <label htmlFor="step4Unsure" className='container1 w-100'>
                                                        ...
                                                        <span className='checkmark checkmarkBoxShadow'>Unsicher, bitte eine kostenlose Beratung</span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div className="py-5">
                                        ...
                                        <div className='wrapDiv container-xl px-0 pt-5'>
                                            <div className='krankenSecondStep'>
                                                <div className='m-5 mx-auto fs-5' style={{ position: "relative" }}>
                                                    ...
                                                    <svg height="100" width="100" viewBox="0 0 100 100" className='testrtr'  >
                                                        <circle className="circle" cx="50" cy="50" r="45" stroke="#27B0Ed" strokeWidth="3" fillOpacity="0" />
                                                        <text x="35" y="55" fontSize={20} fontWeight={500}>5/5</text>
                                                    </svg>
                                                </div>
                                                <div className='pb-5'>
                                                ...
                                                <div className="">
                                                    <div className="row g-4 justify-content-center">
                                                        <div className="col-12 col-sm-6">
                                                            <input type="text" className='krankenInputStyle krankenInputStepStyle p-2 p-3 krankenBoxShadowInput' placeholder='Vorname' name="" id="" />
                                                        </div>
                                                        <div className="col-12 col-sm-6">
                                                            <input type="text" className='krankenInputStyle krankenInputStepStyle p-2 p-3 krankenBoxShadowInput' placeholder='Nachname' name="" id="" />
                                                        </div>

                                                        <div className="col-12 col-sm-6">
                                                            <input type="text" className='krankenInputStyle krankenInputStepStyle p-2 p-3 krankenBoxShadowInput' placeholder='Adresse' name="" id="" />
                                                        </div>
                                                        <div className="col-12 col-sm-6">
                                                            <input type="email" className='krankenInputStyle krankenInputStepStyle p-2 p-3 krankenBoxShadowInput' placeholder='E-Mail-Addresse' name="" id="" />
                                                        </div>
                                                        <div className="col-12 col-sm-6">
                                                            <div className="">
                                                                <input type="tel" className='krankenInputStyle krankenInputStepStyle p-2 p-3 krankenBoxShadowInput' placeholder='Telefonnummer' name="" id="" />
                                                            </div>
                                                        </div>

                                                        <div className="col-12 col-sm-6">
                                                            <select onChange={checkIfSwiss} name="" className='krankenInputStyle form-select krankenInputStepStyle p-3 krankenBoxShadowInput' id="">
                                                        ...
                                                        {!isSwiss && (
                                                            <div className="col-12 col-sm-6">
                                                                <select name="" className='krankenInputStyle form-select krankenInputStepStyle p-3 krankenBoxShadowInput' id="">
                                                    ...
                                                    <div className="pb-3 pt-4 text-start">
                            ...
                            <form id='modalForm' onSubmit={handleModalSubmit} className='m-0'>
                                <div className="row g-4">
                                    ...
                                    <div className="col-12 col-sm-6">
                                        ...
                                        <div>
                                            <select required name="" onChange={e => { setNationalitat(e.target.value); (e.target.value === 'swiss') ? setisSwiss(true) : setisSwiss(false) }} id="" className='krankenInputStyle form-select krankenInputStepStyle p-2'>
