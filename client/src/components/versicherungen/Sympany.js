...
import Logo from '../../assets/images/versicherungen/sympanylogo.png'
import Photo1 from '../../assets/images/versicherungen/sympanyPhoto1.png'

function Sympany() {
    return (
        <>
            <div className='bodyCounterPadding wrapDiv'>
                <div className='heroDiv'>
                    <div className='pb-5'>
                        <img src={Logo} alt="" />
                    </div>
                    <div className=''>
                        <span className='fw-600'>So that there is time for beautiful things.</span>
                    </div>
                </div>
            </div>
            <div className='wrapDiv container-xl px-4 px-lg-5 bodyCounterPadding'>
                <div className=''>
                    <div className='text-start pb-5'>
                        <div className='pb-4'>
                            <span className='finanuSubTitle fs-3 fw-800'>Services</span>
                        </div>
                        <div>
                            <span className='fw-600'>Berechnen Sie die Krankenkassenprämien von Sympany und vergleichen Sie die verschiedenen Modelle. Belege und Rechnungen können über die Mobile App zugeschickt werden. Adressänderungen erledigen Sie unkompliziert online.</span>
                        </div>
                    </div>
                    <div>
                ...
                <div className="row gx-4 justify-content-between">
                    ...
                    <div className="col-12 col-md-6 col-lg-5 my-auto">
                        <div className='text-start pb-4 pb-md-0'>
                            ...
                            <div>
                                <span style={{ lineHeight: '29px' }} className='fw-600'>With Sympany's online services, you can quickly and easly deal
                                    with many matters yourself, such as recording absences or amending your details. Sympany
                                    would be happy to help you with any other matters, for example with our Case Managment
                                    team or through collaboration with other social insurance providers.
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row g-3 justify-content-center">
                        <div className="col-12 col-sm-6 col-md-3">
                            <div className="servicesBorderDiv p-4 p-lg-5">
                                ...
                                <div>
                                    <span className='fw-800'>Telmed</span>
                                </div>
                            </div>
                        </div>
                        <div className="col-12 col-sm-6 col-md-3">
                            <div className="servicesBorderDiv p-4 p-lg-5">
                                ...
                                <div>
                                    <span className='fw-800'>HMO</span>
                                </div>
                            </div>
                        </div>
                        <div className="col-12 col-sm-6 col-md-3">
                            <div className="servicesBorderDiv p-4 p-lg-5">
                                ...
                                <div>
                                    <span className='fw-800'>Hausarzt</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className='wrapDiv container-xl px-4 px-lg-5 bodyCounterPadding text-start'>
                ...
                <div>
                    <div className="pb-3">
                        <span className='fw-600'> Die Sympany bietet eine Reihe von interessanten Zusatzversicherungen an. Die Reiseversicherung und die Zahnversicherung gehören zu den beliebtesten Zusatzversicherungen.
                        </span>
                    </div>
                    <div className="pb-3">
                        <span className='fw-600'>
