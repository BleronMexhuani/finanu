            ...
            <div className='wrapDiv container-xl px-4 px-lg-5 bodyCounterPadding'>
                <div className=''>
                    <div className='text-start pb-5'>
                        ...
                        <div>
                            <span className='fw-600 normalTextToWhite'>Berechnen Sie die Krankenkassenprämien von Sympany und vergleichen Sie die verschiedenen Modelle. Belege und Rechnungen können über die Mobile App zugeschickt werden. Adressänderungen erledigen Sie unkompliziert online.</span>
                        </div>
                    </div>
                    <div>
                            ...
                            <div className="col-12 col-sm-6 col-md-3">
                                <NavLink to='/versicherungen/krankenkasse' className='text-decoration-none text-dark'>
                                    <div className='servicesBorderDiv p-4 p-lg-5'>
                                        ...
                                        <div>
                                            <span className='fw-800 normalTextToWhite'>Prämien berechnen</span>
                                        </div>
                                    </div>
                                </NavLink>
                ...
                <div className="row gx-4 justify-content-between">
                    ...
                    <div className="col-12 col-md-6 col-lg-5 my-auto">
                        <div className='text-start pb-4 pb-md-0'>
                            ...
                            <div>
                                <span style={{ lineHeight: '29px' }} className='fw-600 normalTextToWhite'>With Sympany's online services, you can quickly and easly deal
