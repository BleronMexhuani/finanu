      ...
      <div className="bodyCounterPadding">
        <div className='container-xl px-4 px-xl-5 mt-4'>
          <div className="hausratBlueDiv px-4 px-md-5 pt-4 pt-md-5 pb-4 mb-0">
            <div className="whiteBgRecht p-3 absoluteDivRecht" style={{border: 'none'}}>
              <span style={{ color: "#50B8E7" }} className='fw-700 firstBlueTitle fs-1'>FAQ</span>
            </div>
            <div className="pt-5 text-start whiteBorderParent">
              <div className='whiteBorderBottomRecht pb-2 mb-4' onClick={() => { toggleFaqState(1) }}>
                <div className="row g-0">
                  <div className="col-auto my-auto me-2">
                    <svg width="11" viewBox="0 0 17 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="col my-auto">
                    <div>
                      <span className='fs-5'>Was ist eine Rechtschutzversicherung?</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className='whiteBorderBottomRecht pb-2 mb-4' onClick={() => { toggleFaqState(2) }}>
                <div className="row g-0">
                  ...
                  <div className="col my-auto">
                    <div>
                      <span className='fs-5'>Welchen Rechtschutz braucht man?</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className='whiteBorderBottomRecht pb-2 mb-4' onClick={() => { toggleFaqState(3) }}>
                <div className="row g-0">
                  ...
                  <div className="col my-auto">
                    <div>
                      <span className='fs-5'>Welche Leistungen erhalten Sie?</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className='whiteBorderBottomRecht pb-2 mb-4' onClick={() => { toggleFaqState(4) }}>
                <div className="row g-0">
                  ...
                  <div className="col my-auto">
                    <div>
                      <span className='fs-5'>Ab Wann und wo gilt der Versicherungsschutz?</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className='whiteBorderBottomRecht pb-2 mb-4' onClick={() => { toggleFaqState(5) }}>
                <div className="row g-0">
                  ...
                  <div className="col my-auto">
                    <div>
                      <span className='fs-5'>Benötige ich Rechtschutz, wenn ichbereits eine Haftpflichtversicherung habe?</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className='whiteBorderBottomRecht pb-2 mb-4' onClick={() => { toggleFaqState(7) }}>
                <div className="row g-0">
                  ...
                  <div className="col my-auto">
                    <div>
                      <span className='fs-5'>Ist die Rechtsschutzversicherung in der Schweiz obligatorisch?</span>
                    </div>
                  </div>
                </div>
              </div>
