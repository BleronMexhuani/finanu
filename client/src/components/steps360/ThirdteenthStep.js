...
function ThirdteenthStep(props) {
  const changeMY = (e) => {
  ...
  const handleEightthStep = (e) => {
    ...
    props.setThirdteenthStepInputs(value)
    props.toNext()
  }
  return (
    <div>
      <form className='m-0' onSubmit={handleEightthStep}>
        <div className="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-4 stepsBlueDiv px-4 px-sm-5 pb-5 pt-4 mx-auto">
          <div className='pb-4'>
            <span className='finanuSubTitle fw-800 text-light'>Verschiedenes</span>
          </div>
          <div className='text-start'>
            <div className="row gx-4 gy-0">
              <div className='pb-5 col-12'>
                <div className='pb-2'>
                  <span className='fw-600'>Spenden, Geschenke, Gebühren </span>
                </div>
                <div className="">
                  <div className="row g-3">
                    <div className="col">
                      <div className="row g-0 stepsFormInputs rightBorderDiv">
                        <div className="col">
                          <input name="eightthStepInput" onFocus={(e) => { if(e.target.value === '0') {e.target.value = ''}}}  onChange={(e) => { props.setThirdteenthStepInputs(e.target.value) }} defaultValue={props.thirdteenthStepInputs[0]} type="number" my={"month"} className='w-100 borderRightInput' />
                        </div>
              ...
              <div className='pb-5 col-12'>
                <div className='pb-2'>
                  <span className='fw-600'>Kredite, Darlehen</span>
                </div>
                <div className="">
                  <div className="row g-3">
                    <div className="col">
                      <div className="row g-0 stepsFormInputs rightBorderDiv">
                        <div className="col">
                          <input name="eightthStepInput" onFocus={(e) => { if(e.target.value === '0') {e.target.value = ''}}}  onChange={(e) => { props.setThirdteenthStepInputs(e.target.value) }} defaultValue={props.thirdteenthStepInputs[1]} type="number" my={"month"} className='w-100 borderRightInput' />
                        </div>
                        <div className="col-auto my-auto">
                          <div className='px-2'>
                            <span className='text-dark'>CHF</span>
...
export default ThirdteenthStep