                  ...
                  <div className="row g-3">
                    <div className="col">
                      <div className="row g-0 stepsFormInputs rightBorderDiv">
                        <div className="col">
                          <input name="eightthStepInput" onChange={(e) => { props.setThirdteenthStepInputs(e.target.value) }} defaultValue={props.thirdteenthStepInputs[0]} type="number" my={"month"} className='w-100 borderRightInput' />
                        </div>
                ...
                <div className="">
                  <div className="row g-3">
                    <div className="col">
                      <div className="row g-0 stepsFormInputs rightBorderDiv">
                        <div className="col">
                          <input name="eightthStepInput" onChange={(e) => { props.setThirdteenthStepInputs(e.target.value) }} defaultValue={props.thirdteenthStepInputs[1]} type="number" my={"month"} className='w-100 borderRightInput' />
                        </div>
                        <div className="col-auto my-auto">
                          <div className='px-2'>
                            <span className='text-dark'>CHF</span>
