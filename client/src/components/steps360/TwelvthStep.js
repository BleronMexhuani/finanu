...
function TwelvthStep(props) {
  ...
  const handleEightthStep = (e) => {
    ...
    props.setTwelvthStepInputs(value)
    props.toNext()
  }
  return (
    <div>
      <form className='m-0' onSubmit={handleEightthStep}>
        <div className="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-4 stepsBlueDiv px-4 px-sm-5 pb-5 pt-4 mx-auto">
          <div className='pb-4'>
            <span className='fs-4 fw-800'>Steuern</span>
          </div>
          <div className='text-start'>
            <div className="row gx-4 gy-0">
              <div className='pb-5 col-12'>
                <div className='pb-2'>
                  <span className='fw-600'>Steuern </span>
                </div>
                <div className="">
              ...
              <div className='pb-5 col-12'>
                <div className='pb-2'>
                  <span className='fw-600'>Militärpflichtersatz</span>
                </div>
                <div className="">
                  <div className="row g-3">
                    <div className="col">
