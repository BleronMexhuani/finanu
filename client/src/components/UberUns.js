                        ...
                        <div className="whiteBgUber px-5 py-5 h-100">
                            <div>
                                <svg width="129" height="109" viewBox="0 0 129 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1.12305 44C20.7897 11.6667 72.823 -33.1998 127.623 42.0002" stroke="black" strokeWidth="1.5" />
                                    <path d="M127.5 41.5C107.756 69.5886 56.138 108.827 1.12305 43.4995" stroke="black" strokeWidth="1.5" />
                                    <path d="M92.373 41C92.373 48.4796 88.7234 55.2876 83.2135 60.2413C77.701 65.1972 70.3756 68.25 63.123 68.25C55.8977 68.25 50.1091 65.2214 46.1122 60.3247C42.1041 55.4145 39.873 48.5912 39.873 41C39.873 25.9595 53.1162 13.25 67.623 13.25C82.025 13.25 92.373 25.8478 92.373 41Z" fill="#BEE8FF" stroke="black" strokeWidth="1.5" />
                                    <path d="M79.373 32.0531C79.373 33.4298 78.6694 34.722 77.5436 35.6893C76.4163 36.6579 74.9201 37.25 73.4564 37.25C72.0173 37.25 70.8929 36.6792 70.1174 35.7711C69.332 34.8516 68.873 33.5462 68.873 32.0531C68.873 29.2236 71.515 26.75 74.4564 26.75C77.2902 26.75 79.373 29.114 79.373 32.0531Z" fill="#BEE8FF" stroke="black" strokeWidth="1.5" />
                                    <path d="M15.123 40.5C16.2897 41.8333 18.823 44.6 19.623 45" stroke="black" strokeWidth="0.5" strokeLinecap="round" />
                                    <path d="M119.803 42C119.746 45.1618 116.219 49.8075 115.217 50.7735" stroke="black" strokeWidth="0.5" strokeLinecap="round" />
                                    <path d="M11.623 46C16.623 54 23.123 56.5 26.5574 58.1391" stroke="black" strokeWidth="0.5" strokeLinecap="round" />
                                </svg>
