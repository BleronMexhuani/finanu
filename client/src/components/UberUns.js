                        ...
                        <div className="whiteBgUber px-5 py-5 h-100">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="138" height="109" viewBox="0 0 128 79" fill="none">
                                    <path d="M87.5 5.42188C44.3 -11.3781 11.8333 23.7553 1 42.9219C65 120.922 129 45.5128 126.5 40.5128C123 33.5128 105 14.9219 87.5 5.42188Z" fill="white" stroke="black" strokeWidth="1.5" />
                                    <path d="M90.25 38.0957C90.25 45.5753 86.6004 52.3833 81.0905 57.337C75.5779 62.2929 68.2525 65.3457 61 65.3457C53.7747 65.3457 47.9861 62.3171 43.9891 57.4204C39.9811 52.5102 37.75 45.687 37.75 38.0957C37.75 23.0553 50.9932 10.3457 65.5 10.3457C79.9019 10.3457 90.25 22.9435 90.25 38.0957Z" fill="#BEE8FF" stroke="black" strokeWidth="1.5" />
                                    <path d="M77.25 29.1488C77.25 30.5255 76.5463 31.8177 75.4205 32.785C74.2933 33.7536 72.7971 34.3457 71.3333 34.3457C69.8942 34.3457 68.7699 33.7749 67.9943 32.8668C67.209 31.9473 66.75 30.6419 66.75 29.1488C66.75 26.3193 69.3919 23.8457 72.3333 23.8457C75.1671 23.8457 77.25 26.2097 77.25 29.1488Z" fill="#BEE8FF" stroke="black" strokeWidth="1.5" />
                                    <path d="M13 37.5957C14.1667 38.929 16.7 41.6957 17.5 42.0957" stroke="black" strokeWidth="0.5" strokeLinecap="round" />
                                    <path d="M117.68 39.0957C117.623 42.2575 114.096 46.9032 113.094 47.8692" stroke="black" strokeWidth="0.5" strokeLinecap="round" />
                                    <path d="M9.5 43.0957C14.5 51.0957 21 53.5957 24.4344 55.2348" stroke="black" strokeWidth="0.5" strokeLinecap="round" />
                                </svg>
